export default function BlogSkeletonCard() {
  return (
    <>
      <div
        role="blogskeletoncard"
        className="bg-white w-full p-6 rounded-lg border border-[#ebe6e0] animate-pulse"
      >
        {/* Title & Excerpt */}
        <div
          role="titleandexcerpt"
        ...
        {/* Author & Posted On */}
        <div role="authorandpostedon" className="flex justify-between mt-5 items-center">
