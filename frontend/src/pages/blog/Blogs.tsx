              ...
              {getPageWindow(currentPage, totalPages).map((num, idx) => {
                return (
                  <li
                    ...
                    className={
                      currentPage === num
                        ? "text-white bg-orange-500/90 border-orange-500 border duration-300 ease-out cursor-pointer rounded-md px-3 py-1 font-sans font-semibold text-sm"
                        : "border border-gray-500 hover:border-orange-500 duration-300 ease-out cursor-pointer rounded-md px-3 py-1 font-sans font-semibold text-sm hover:bg-orange-500/90 hover:text-white"
                    }
                  >
                    {num}
                  </li>
