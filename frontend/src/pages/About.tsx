        ...
        <div className="w-full md:w-2xl lg:w-3xl px-4 mx-auto">
          ...
          <div>
            ...
            <p className="text-[#7c706a] text-lg my-6 font-sans">
              Tiger Writes is a platform where words roar to life. We believe that every writer has
              a unique voice that deserves to be heard, and every story has the power to connect,
              inspire, and transform.
            </p>
            <p className="text-[#7c706a] text-lg my-6 font-sans">
              Founded on the principles of authenticity and community, we've created a space where
              writers can share their perspectives on any topic that matters to them. Whether you're
              a seasoned author or just beginning your writing journey, Tiger Writes welcomes you.
            </p>
          </div>
          {/* Our Mission */}
          <AboutCard
