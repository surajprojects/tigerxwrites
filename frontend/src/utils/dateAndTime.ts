...
export function verifyDate(yyyymmdd = "2025-01-01") {
    if (yyyymmdd.length === 10) {
        if (detoxDate(yyyymmdd.slice(8)) && detoxDate(yyyymmdd.slice(5, 7)) && detoxDate(yyyymmdd.slice(0, 4))) {
            if ((Number(yyyymmdd.slice(0, 4)) > 1900) && (Number(yyyymmdd.slice(5, 7)) > 0 && Number(yyyymmdd.slice(5, 7)) < 13) && (Number(yyyymmdd.slice(8)) > 0 && Number(yyyymmdd.slice(8)) < 32)) {
                return true;
            }
        }
    }
